...
export default function StatsPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full max-w-7xl mx-auto px-4 py-12 space-y-8">
      <div className="flex items-center space-x-4 w-full max-w-7xl">
        <Link href="/digit-span">
          <Button variant="ghost" size="icon">
            <ArrowLeft className="w-5 h-5" />
          </Button>
        </Link>
        <h1 className="text-3xl font-bold">Your Performance Stats</h1>
      </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="p-4 text-center border rounded-lg">
                ...
                <p className="text-3xl font-bold">{stats.forward.best}</p>
              </div>
              <div className="p-4 text-center border rounded-lg">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="p-4 text-center border rounded-lg">
                <p className="text-sm text-muted-foreground">Best Score</p>
                <p className="text-3xl font-bold">{stats.backward.best}</p>
              </div>
              <div className="p-4 text-center border rounded-lg">
                <p className="text-sm text-muted-foreground">Average</p>
                <p className="text-3xl font-bold">
      ...
      <Tabs defaultValue="forward" className="w-full">
        <TabsList className="grid w-full max-w-md grid-cols-2">
          <TabsTrigger value="forward">Forward History</TabsTrigger>
          <TabsTrigger value="backward">Backward History</TabsTrigger>
        </TabsList>
        <TabsContent value="forward" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle>Forward Span History</CardTitle>
        ...
        <TabsContent value="backward" className="mt-6">
          <Card>
            <CardHeader>
              <CardTitle>Backward Span History</CardTitle>
              <CardDescription>Your performance over time</CardDescription>
            </CardHeader>
            <CardContent className="h-80">
